...
public class ItemTubeTurbo extends ItemBlockWithMetadata {
    public static ItemTubeTurbo instance;

    public ItemTubeTurbo(Block b) {
        super(b, b);
        instance = this;
    }
    ...
    public IIcon getIconFromDamage(int meta) {
        if (meta == 0) {
            ...
            if (stack != null && stack.getItem() == this && stack.getItemDamage() == 0)
                return BlockTubeTurbo.instance.getIcon(0, TubeTransportSystem.proxy.lastSideHit);
            else
